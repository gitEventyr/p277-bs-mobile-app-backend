...
let UsersService = class UsersService {
    ...
    async getCasinoActionsCounts(visitorIds) {
        ...
        const result = await this.casinoActionRepository
            ...
            .addSelect('COUNT(DISTINCT CASE WHEN action.registration = true THEN CONCAT(action.casino_name, action.visitor_id) END)', 'registrations')
            .addSelect('COUNT(DISTINCT CASE WHEN action.deposit = true THEN CONCAT(action.casino_name, action.visitor_id) END)', 'deposits')
    ...
    async getUserCasinoActions(visitorId) {
        if (!visitorId) {
            return [];
        }
